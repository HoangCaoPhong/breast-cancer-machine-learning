...
- [../reports/README.md](../reports/README.md): report, figure và table.

Biên bản chi tiết có thể lưu dưới `meeting-notes/`. Không ghi một hạng mục là hoàn
tất nếu chưa có code/config/kết quả hoặc bằng chứng kiểm tra tương ứng.
